...
HELP_TOPICS = {
    ...
    "adjuntos": (
        ...
        "\n"
        "Con lo que leo también completo la ficha del proveedor: CUIT, mail,\n"
        "teléfono, condición de IVA y domicilio. Sólo lo que esté vacío — si el\n"
        "dato ya está cargado no lo toco.\n"
        "\n"
